...
class App(ctk.CTk):
    ...
    def manipulate_image(self, *args):
        ...
        if self.color_vars['vibrance'].get() != BRIGHTNESS_DEFAULT:
    ...
    def resize_image(self, event):
        # print(event)
        canvas_ration = event.width / event.height

        self.canvas_width = event.width
        self.canvas_height = event.height
        if canvas_ration > self.image_ratio:
